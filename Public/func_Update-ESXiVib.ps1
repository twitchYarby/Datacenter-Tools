<#
.Synopsis
    Updates a Vib on the specified ESXi host from a local datastore
.Description
    This command is the PowerCLI equivalent of executing the shell command: esxcli software vib update
#>
function Update-ESXiVib {
    [CmdletBinding()]
    Param(
        [Parameter(Mandatory)]
    ...
    $VMHostESXCLI.software.vib.update.Invoke($arguments)
}
